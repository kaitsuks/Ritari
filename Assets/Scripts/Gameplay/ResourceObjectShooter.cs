...
[AddComponentMenu("Playground/Gameplay/Resource Object Shooter")]
public class ResourceObjectShooter : MonoBehaviour
{
	...
	void Start ()
	{
        ...
        ra = gameObject.GetComponent<ConsumeResourceAction>();
	}
	...
	void Update ()
	{
		   ...
		   && Time.time >= timeOfLastSpawn + creationRate)
		{
            ...
            ra.ExecuteAction(prefabToSpawn);
